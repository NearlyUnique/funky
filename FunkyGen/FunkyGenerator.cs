...
public sealed partial class FunkyGenerator : IIncrementalGenerator
{
    ...
    {
        var mockClass = source.MockClass;
        var targetInterface = source.TargetInterface;
        string? mockClassNamespace = mockClass.ContainingNamespace.IsGlobalNamespace ? null : mockClass.ContainingNamespace.ToDisplayString();
        string mockClassName = mockClass.Name;
...
#nullable enable
namespace {source.MockClassNamespace};
public partial class {source.MockClassName} // : {source.TargetInterfaceNamespace}.{source.TargetInterfaceName}
{{
{list}
}}";
