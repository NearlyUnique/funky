...
using Xunit;
using VerifyCS = FunkyMockTests.Verifiers.CSharpSourceGeneratorVerifier<FunkyMock.FunkyIncrementalGenerator>;
...
#nullable enable
namespace FunkyMock;
[global::System.CodeDom.Compiler.GeneratedCodeAttribute(""FunkyMock"", ""{typeof(FunkyIncrementalGenerator).Assembly.GetName().Version}"")]
...
[Funky]
public partial class SomeMock : ISimple {
}
""";
